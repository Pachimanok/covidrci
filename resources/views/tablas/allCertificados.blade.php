                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-sm" role="group" >
                            <a href="{{asset('certificados/'.$certficado->archivo)}}" download="{{ $certficado->archivo }}" class="btn btn-outline-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer" viewBox="0 0 16 16">
